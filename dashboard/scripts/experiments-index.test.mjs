...
test('familyOf: known ids, keyword heuristics, declared family, fallback', () => {
  ...
  assert.equal(familyOf('kalshi_whale_noise_combined'), 'kalshi_flb')
  assert.equal(familyOf('kalshi_noise_taker_leg'), 'kalshi_flb')
  assert.equal(familyOf('tennis_whale_follow'), 'kalshi_flb')
  ...
  assert.equal(familyOf('fade_the_tourist'), 'tourist_fade')
  assert.equal(familyOf('tourist_fade_crypto'), 'tourist_fade')
  assert.equal(familyOf({ track: 'mystery', metrics: { family: 'tourist_fade' } }), 'tourist_fade')
