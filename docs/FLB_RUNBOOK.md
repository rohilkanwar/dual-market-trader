...
Run `20260914T214602Z-flb-aed44114`; committed as
...
| --- | --- | --- | --- | --- |
| `<10c` | 37 | 1.9¢ | 6.7% | **26.9%** |
| `10-20c` | 29 | 7.1¢ | 5.8% | 24.5% |
| `40-50c` | 11 | 11.9¢ | 3.5% | 14.2% |
| `80-90c` | 19 | 9.8¢ | 0.7% | 6.1% |
| `>=90c` | 38 | 2.9¢ | 0.2% | **1.8%** |

* `longshot_take_cost_exceeds_favorite`: **PASS** — 25.7% vs 4.0% of the price paid.
...
### Paper tracks on that snapshot (ledgers carried from the same-day 15-market canary; the tracks also run inside the twelve-track `measure_all` scoreboard)

| Track | Longshot candidates | Admitted | Fills | Realized | Unrealized | Fees | Refusals |
| --- | --- | --- | --- | --- | --- | --- | --- |
| `kalshi_longshot_fade` | 105 | 39 | 39 | −4.38 | −13.71 | 4.38 | `capital_cap_reached` 66 |
| `kalshi_maker_quote` | 105 | 39 | 25 | −0.59 | −3.27 | 0.59 | `capital_cap_reached` 66 |
| shadow longshot buyer | — | — | 39 | — | — | 37.13 | total −147.75 |

Per longshot band (paper PnL on notional, marked from the same snapshot): fade
`<10c` −120 bps / `10-20c` −288 bps; maker `<10c` −112 bps / `10-20c` −136 bps; shadow
longshot buyer `<10c` **−2,900 bps** / `10-20c` −2,125 bps. The fade pays the half-spread
