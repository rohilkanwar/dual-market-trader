...
* Ledger aggregation across tracks sums six independent `1000` starting-cash books (`portfolio.starting_cash = 6000`); per-track figures are under `portfolio.by_track` and the primary track under `portfolio.primary`.
...
## 9. News / underreaction lane (optional sixth track)
